...
public class BasketballPlayer extends Athelete { //extends allows for inheritance from Athelete class
	...
	public String displayStats() {
		String result = String.format("This Basketball Player's stats are: \n Strength: %d, Speed: %d, Stamina: %d, Shooting Skill: %d, First Name: %s, Last Name: %s", this.strength, this.speed, this.shootingSkillLevel,  this.firstName, this.lastName);
